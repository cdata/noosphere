...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "LibNoosphere",
            url: "https://github.com/cdata/noosphere/releases/download//libnoosphere-apple-xcframework.zip",
            checksum: "c83cffc2a93a2831e5e4806ed5d5d2032b5bcbb59b0c276d9c8f3cbeccdfa9c2"),
        .testTarget(
